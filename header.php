    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-white shadow-lg border-r border-gray-200">
            ...
            <nav class="p-4">
                <ul class="space-y-1">
                    <li>
                        <a href="index.php" class="sidebar-item <?php echo $current_page === 'index.php' ? 'active' : ''; ?> flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all">
                            <i class="fas fa-tachometer-alt mr-3"></i>
                            Dashboard
                        </a>
                    </li>
                    <li>
                        <div class="sidebar-item flex items-center px-3 py-2 text-sm font-medium rounded-lg cursor-pointer transition-all" data-submenu="repository">
                    ...
                    <li>
                        <a href="insights.php" class="sidebar-item <?php echo $current_page === 'insights.php' ? 'active' : ''; ?> flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all">
                            <i class="fas fa-chart-line mr-3"></i>
                            Insights
                        </a>
                    </li>
                    <li>
                        <a href="tasks.php" class="sidebar-item <?php echo $current_page === 'tasks.php' ? 'active' : ''; ?> flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all">
                            <i class="fas fa-tasks mr-3"></i>
                            Tasks
                        </a>
                    </li>
                    <li>
                        <a href="template-library.php" class="sidebar-item <?php echo $current_page === 'template-library.php' ? 'active' : ''; ?> flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all">
                            <i class="fas fa-file-alt mr-3"></i>
                            Templates
                        </a>
                    </li>
                    <li>
                        <div class="sidebar-item flex items-center px-3 py-2 text-sm font-medium rounded-lg cursor-pointer transition-all" data-submenu="settings">
                    ...
                    <li>
                        <a href="knowledge-hub.php" class="sidebar-item <?php echo $current_page === 'knowledge-hub.php' ? 'active' : ''; ?> flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all">
            ...
            <div class="absolute bottom-0 w-64 p-4 border-t border-gray-200 bg-white">
                <div class="flex items-center">
                    ...
                    <div class="relative">
                        <button id="user-menu-btn" class="text-gray-400 hover:text-gray-600">
